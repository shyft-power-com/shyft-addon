...
5. die letzten Frage/Antwort-Paare (ai_task.generate_data ist Einzelaufruf, kein Chat-Verlauf)."""
import json
...
def build_prompt(question, history, ui_help, config, problems, states):
